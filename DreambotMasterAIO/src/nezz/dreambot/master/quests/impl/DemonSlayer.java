 ...
 *
 * VarPlayer 18: 0=not started, 1-6=in progress, 7=complete
 */
public final class DemonSlayer extends Quest {
    ...
    public DemonSlayer() {
        ...
        steps.put(0, QuestStep.talkTo("Gideon Bede",
            () -> PlayerSettings.getConfig(Varbits.QUEST_DEMON_SLAYER) > 0));
        // Stage 1: Collect the three silver keys (from different holders)
        steps.put(1, QuestStep.talkTo("Traiborn",
            () -> PlayerSettings.getConfig(Varbits.QUEST_DEMON_SLAYER) >= 3));
        steps.put(3, QuestStep.talkTo("Gideon Bede",
            () -> PlayerSettings.getConfig(Varbits.QUEST_DEMON_SLAYER) >= 5));
        ...
        steps.put(6, QuestStep.walkTo(
            ...
            () -> PlayerSettings.getConfig(Varbits.QUEST_DEMON_SLAYER) >= 7));
        steps.put(7, QuestStep.noop("complete"));
    }

    @Override public String name()       { return "Demon Slayer"; }
    @Override public int stageVarp()     { return Varbits.QUEST_DEMON_SLAYER; }
