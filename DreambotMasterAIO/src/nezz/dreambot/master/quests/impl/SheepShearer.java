 ...
 *
 * Tracked by VarPlayer {@link Varbits#QUEST_SHEEP_SHEARER}. Stages are
...
public final class SheepShearer extends Quest {
    ...
    public SheepShearer() {
        steps.put(0, QuestStep.talkTo("Fred the Farmer",
                () -> PlayerSettings.getConfig(Varbits.QUEST_SHEEP_SHEARER) > 0));
        ...
        steps.put(20, QuestStep.talkTo("Fred the Farmer",
                () -> PlayerSettings.getConfig(Varbits.QUEST_SHEEP_SHEARER) >= 21));
        steps.put(21, QuestStep.noop("complete"));
    }

    @Override public String name() { return "Sheep Shearer"; }
    @Override public int stageVarp() { return Varbits.QUEST_SHEEP_SHEARER; }
